                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="state" class="col-md-4 col-form-label text-md-end">Drzava</label>
                            ...
                            <div class="row mb-3">
                                <label for="town" class="col-md-4 col-form-label text-md-end">Opstina</label>

                                <div class="col-md-6">
                                    <input id="town" type="text" class="form-control @error('town') is-invalid @enderror"
                                        name="town" value="{{ old('town') }}" required autocomplete="name" autofocus>
